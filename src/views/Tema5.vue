      ...
      .col-lg-7
        LineaTiempoD.color-primario
          ...
          .row(numero="3" titulo="Tercer paso")
            .col-12
              p En el script que se observa a continuación, se comentarán todos los ajustes correspondientes; los parámetros son esenciales para darle la forma y función al gráfico, pero puede cambiar y jugar con estos valores para estudiar sus cambios.
